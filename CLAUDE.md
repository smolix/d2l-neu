...
- Source .md files live in chapter_*/ directories alongside the generated .qmd files.
  The .md files are the source of truth — .qmd files are GENERATED by d2l_preprocess.py.
  Do NOT manually edit .qmd files — edits will be overwritten on next preprocess run.
  All content fixes must go into the .md source files or the preprocessor.
...
- Source .md files are in-repo (chapter_*/*.md); no external d2l-en dependency
