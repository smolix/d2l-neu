# Attention Mechanisms and Transformers {#sec-chap-attention-and-transformers}
...
models resembling classical convolutional neural networks (@sec-chap-cnn)
retained *state-of-the-art* status in computer vision
and models resembling Sepp Hochreiter's original design
for the LSTM recurrent neural network (@sec-lstm),
...
(e.g., BERT [@Devlin.Chang.Lee.ea.2018], ELECTRA [@clark2019electra], RoBERTa [@Liu.Ott.Goyal.ea.2019], or Longformer [@beltagy2020longformer])
...
centered on the GPT-2 and GPT-3 Transformer-based models [@Radford.Wu.Child.ea.2019; @brown2020language].
...
semantic segmentation, and superresolution [@Dosovitskiy.Beyer.Kolesnikov.ea.2021; @liu2021swin].
Transformers also showed up as competitive methods
for speech recognition [@gulati2020conformer],
reinforcement learning [@chen2021decision],
and graph neural networks [@dwivedi2020generalization].
...
such as machine translations [@Bahdanau.Cho.Bengio.2014].
You might recall that in the first sequence-to-sequence models
for machine translation [@Sutskever.Vinyals.Le.2014],
...
@Vaswani.Shazeer.Parmar.ea.2017 proposed
...
now sometimes called *foundation models* [@bommasani2021opportunities].
