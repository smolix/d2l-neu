...
# Layers and Modules {#sec-model-construction}
...
often recursively. This is illustrated in @fig-blocks. By defining code to generate modules
of arbitrary complexity on demand,
we can write surprisingly compact code
and still implement complex neural networks.

![Multiple layers are combined into modules, forming repeating patterns of larger models.](../img/blocks.svg){#fig-blocks}
...
## The Sequential Module {#sec-model-construction-sequential}
