# Fully Convolutional Networks {#sec-fcn}

As discussed in @sec-semantic-segmentation,
...
introduced in @sec-transposed-conv.
As a result,
...
the transposed convolution introduced in @sec-transposed-conv. 
As a result,
...
![Fully convolutional network.](../img/fcn.svg){#fig-fcn}
...
the output shape of a convolutional layer in @sec-padding. 
...
the image scaled up by bilinear interpolation and the original image printed in @sec-bbox look the same.
...
as introduced in @sec-semantic-segmentation. 
