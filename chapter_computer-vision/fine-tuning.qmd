...
In this section, we will introduce a common technique in transfer learning: *fine-tuning*. As shown in @fig-finetune, fine-tuning consists of the following four steps:
...
![Fine tuning.](../img/finetune.svg){#fig-finetune}
