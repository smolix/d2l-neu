# Image Augmentation {#sec-image-augmentation}
...
In @sec-pooling, we explained that the pooling layer can reduce the sensitivity of a convolutional layer to the target position.
...
For
a detailed introduction to `DataLoader`, please refer to @sec-fashion-mnist.
...
multi-GPU training in @sec-multi-gpu-concise.
In the following,
