...
## Connection to Matrix Transposition {#sec-connection-to-mat-transposition}
...
1. In @sec-connection-to-mat-transposition, the convolution input `X` and the transposed convolution output `Z` have the same shape. Do they have the same value? Why?
