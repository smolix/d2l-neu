...
# Network in Network (NiN) {#sec-nin}
...
The *network in network* (*NiN*) blocks [@Lin.Chen.Yan.2013] offer an alternative,
...
Recall @sec-1x1. In it we said that the inputs and outputs of convolutional layers
...
@fig-nin illustrates the main structural
...
![Comparing the architectures of VGG and NiN, and of their blocks.](../img/nin.svg){#fig-nin width="600px"}
