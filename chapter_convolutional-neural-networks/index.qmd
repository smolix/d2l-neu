# Convolutional Neural Networks {#sec-chap-cnn}
...
[@LeCun.Jackel.Bottou.ea.1995], a powerful family of neural networks that
...
[@Deng.Dong.Socher.ea.2009] it was only the use of convolutional neural
networks, in short Convnets, that provided significant performance
improvements [@Krizhevsky.Sutskever.Hinton.2012].
...
GPU cores [@Chetlur.Woolley.Vandermersch.ea.2014].  Consequently, practitioners often
...
structure, such as audio [@Abdel-Hamid.Mohamed.Jiang.ea.2014], text
[@Kalchbrenner.Grefenstette.Blunsom.2014], and time series analysis
[@LeCun.Bengio.ea.1995], where recurrent neural networks are
conventionally used.  Some clever adaptations of CNNs have also
brought them to bear on graph-structured data [@Kipf.Welling.2016] and
