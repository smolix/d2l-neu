...
The architecture is summarized in @fig-lenet.

![Data flow in LeNet. The input is a handwritten digit, the output is a probability over 10 possible outcomes.](../img/lenet.svg){#fig-lenet}
...
what we expect from @fig-lenet-vert.
...
![Compressed notation for LeNet-5.](../img/lenet-vert.svg){#fig-lenet-vert}
