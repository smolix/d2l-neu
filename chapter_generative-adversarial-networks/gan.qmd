# Generative Adversarial Networks {#sec-basic-gan}
...
![Generative Adversarial Networks](../img/gan.svg){#fig-gan}
...
$$ \min_D \{ - y \log D(\mathbf x) - (1-y)\log(1-D(\mathbf x)) \},$$ {#eq-gan-auto-1}
...
$$ \max_G \{ - (1-y) \log(1-D(G(\mathbf z))) \} = \max_G \{ - \log(1-D(G(\mathbf z))) \}.$$ {#eq-gan-auto-2}
...
$$ \min_G \{ - y \log(D(G(\mathbf z))) \} = \min_G \{ - \log(D(G(\mathbf z))) \}, $$ {#eq-gan-auto-3}
...
$$\min_D \max_G \{ -E_{x \sim \textrm{Data}} \log D(\mathbf x) - E_{z \sim \textrm{Noise}} \log(1 - D(G(\mathbf z))) \}.$$ {#eq-gan-auto-4}
