...
Figure @synchronous-sh shows the scheduling of synchronous SH with $\eta=2$
...
![Synchronous successive halving with two workers.](../img/sync_sh.svg){#synchronous-sh}
...
@asha shows the scheduling of the same configurations for ASHA. Once Trial-1
...
![Asynchronous successive halving (ASHA) with two workers.](../img/asha.svg){#asha}
