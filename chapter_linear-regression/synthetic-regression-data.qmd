...
we add the code to the `__init__` method of a subclass of `d2l.DataModule` (introduced in @oo-design-data). 
...
registering it in the `SyntheticRegressionData` class via `add_to_class` (introduced in @oo-design-utilities).
