...
# Predicting House Prices on Kaggle {#sec-kaggle-house}
...
![The Kaggle website.](../img/kaggle.png){#fig-kaggle width="400px"}

On the house price prediction competition page, as illustrated
in @fig-house-pricing,
...
![The house price prediction competition page.](../img/house-pricing.png){#fig-house-pricing width="400px"}
...
using `pandas`, which we introduced in @sec-pandas.
...
$$x \leftarrow \frac{x - \mu}{\sigma},$$ {#eq-kaggle-house-price-auto-1}
...
multiclass labels into vectors (see @sec-classification-problem).
...
$$\sqrt{\frac{1}{n}\sum_{i=1}^n\left(\log y_i -\log \hat{y}_i\right)^2}.$$ {#eq-kaggle-house-price-auto-2}
...
in @sec-generalization-model-selection, where we discussed how to deal
...
Next, as demonstrated in @fig-kaggle-submit2,
...
![Submitting data to Kaggle.](../img/kaggle-submit2.png){#fig-kaggle-submit2 width="400px"}
