...
In :numref:`chap_transformers` and :numref:`chap_modern_rnn`,
we have also designed encoder--decoder models, transformer-based and
recurrent, for sequence-to-sequence tasks such as machine translation.
...
are more feasible.
In the following, we start with the sentiment analysis application
