# Natural Language Processing: Applications {#sec-nlp-app}

We have seen how to represent tokens in text sequences and train their representations in @sec-nlp-pretrain.
