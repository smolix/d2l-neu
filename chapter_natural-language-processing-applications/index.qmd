# Natural Language Processing: Applications {#sec-chap-nlp-app}

We have seen how to represent tokens in text sequences and train their representations in @sec-chap-nlp-pretrain.
...
For instance, in @sec-chap-rnn,
we have relied on RNNs to design language models to generate novella-like text.
In @sec-chap-modern-rnn and @sec-chap-attention-and-transformers,
...
![Pretrained text representations can be fed to various deep learning architectures for different downstream natural language processing applications. This chapter focuses on how to design models for different downstream natural language processing applications.](../img/nlp-map-app.svg){#fig-nlp-map-app}

As depicted in @fig-nlp-map-app,
...
Though it is possible to combine any pretrained text representations with any architecture for either application in @fig-nlp-map-app,
...
As we have introduced in @sec-bert,
