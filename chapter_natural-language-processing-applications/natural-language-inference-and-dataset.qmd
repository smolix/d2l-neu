# Natural Language Inference and the Dataset {#sec-natural-language-inference-and-dataset}

In @sec-sentiment, we discussed the problem of sentiment analysis.
...
Stanford Natural Language Inference (SNLI) Corpus is a collection of over 500000 labeled English sentence pairs [@Bowman.Angeli.Potts.ea.2015].
