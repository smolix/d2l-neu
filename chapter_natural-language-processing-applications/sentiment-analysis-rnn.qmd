# Sentiment Analysis: Using Recurrent Neural Networks {#sec-sentiment-rnn} 
...
illustrated in @fig-nlp-map-sa-rnn,
...
![This section feeds pretrained GloVe to an RNN-based architecture for sentiment analysis.](../img/nlp-map-sa-rnn.svg){#fig-nlp-map-sa-rnn}
