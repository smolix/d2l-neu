# Pretraining BERT {#sec-bert-pretraining}

With the BERT model implemented in @sec-bert
and the pretraining examples generated from the WikiText-2 dataset in @sec-bert-dataset, we will pretrain BERT on the WikiText-2 dataset in this section.
...
as in the `train_ch13` function (see @sec-image-augmentation),
...
Recall the input representation of BERT as discussed in @sec-bert-input-rep.
...
In @sec-chap-nlp-app, we will fine-tune a pretrained BERT model
