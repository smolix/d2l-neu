# Natural Language Processing: Pretraining {#sec-chap-nlp-pretrain}
...
In practice, it is very common to use natural language processing techniques to process and analyze text (human natural language) data, such as language models in @sec-language-model and machine translation models in @sec-machine-translation.
...
as highlighted in @fig-nlp-map-pretrain.

![Pretrained text representations can be fed to various deep learning architectures for different downstream natural language processing applications. This chapter focuses on the upstream text representation pretraining.](../img/nlp-map-pretrain.svg){#fig-nlp-map-pretrain}


For sight of the big picture,
@fig-nlp-map-pretrain shows that
...
We will cover them in @sec-chap-nlp-app.
