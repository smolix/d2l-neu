# Optimization and Deep Learning {#sec-optimization-intro}
...
As described
in @sec-empirical-risk-and-risk,
the empirical risk
is an average loss
...
$$f(x) = x \cdot \textrm{cos}(\pi x) \textrm{ for } -1.0 \leq x \leq 2.0,$$ {#eq-optimization-intro-auto-1}
...
Recall our commonly-used activation functions and their derivatives in @sec-activation-functions.
