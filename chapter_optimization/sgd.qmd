...
Plugging both inequalities @eq-sgd-L and @eq-sgd-f-xi-xstar into @eq-sgd-xt+1-xstar we obtain a bound on the distance between parameters at time $t+1$ as follows:
