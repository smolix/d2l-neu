...
have emerged---e.g., @Goodfellow.Bengio.Courville.2016,
...
so we decided to assemble our own (@sec-how-to-contribute).
...
and applications (@fig-book-org).

![Book structure.](../img/book-org.svg){#fig-book-org}


* **Part 1: Basics and Preliminaries**.
@sec-chap-introduction is
an introduction to deep learning.
Then, in @sec-chap-preliminaries,
...
@sec-chap-regression and @sec-chap-perceptrons
...
of these classes and functions in @sec-d2l.
...
please consult @sec-chap-installation
...
*Linear Analysis* by @Bollobas.1999
