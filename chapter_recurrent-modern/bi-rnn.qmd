# Bidirectional Recurrent Neural Networks {#sec-bi-rnn}
...
![Architecture of a bidirectional RNN.](../img/birnn.svg){#fig-birnn}
...
$$\mathbf{O}_t = \mathbf{H}_t \mathbf{W}_{\textrm{hq}} + \mathbf{b}_\textrm{q}.$$ {#eq-bi-rnn-auto-1}
