...
# The Encoder--Decoder Architecture {#sec-encoder-decoder}
...
is to design an *encoder--decoder* architecture (@fig-encoder-decoder)
...
![The encoder--decoder architecture.](../img/encoder-decoder.svg){#fig-encoder-decoder}
