...
$$\tilde{\mathbf{H}}_t = \tanh(\mathbf{X}_t \mathbf{W}_{\textrm{xh}} + \left(\mathbf{R}_t \odot \mathbf{H}_{t-1}\right) \mathbf{W}_{\textrm{hh}} + \mathbf{b}_\textrm{h}),$$ {#gru-tilde-H}
...
Comparing with @rnn-h-with-state,
...
we recover a vanilla RNN such as that in @rnn-h-with-state.
