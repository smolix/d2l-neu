# Modern Recurrent Neural Networks {#sec-chap-modern-rnn}
...
Recall that in @sec-chap-rnn we dealt 
...
The first, *Long Short-Term Memory* [@Hochreiter.Schmidhuber.1997],
...
The second paper, *Bidirectional Recurrent Neural Networks* [@Schuster.Paliwal.1997],
...
[@Graves.Schmidhuber.2005] and handwriting recognition [@graves2008novel].
