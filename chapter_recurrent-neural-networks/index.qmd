# Recurrent Neural Networks {#sec-chap-rnn}
...
and multilayer perceptrons in @sec-chap-perceptrons,
...
As the unfolded view in @fig-unfolded-rnn reveals,
...
![On the left recurrent connections are depicted via cyclic edges. On the right, we unfold the RNN over time steps. Here, recurrent edges span adjacent time steps, while conventional connections are computed synchronously.](../img/unfolded-rnn.svg){#fig-unfolded-rnn}
...
which will be covered in @sec-chap-attention-and-transformers.
