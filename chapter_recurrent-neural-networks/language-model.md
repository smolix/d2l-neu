...
Perplexity can be best understood as the geometric mean of the effective number of real choices that we have when deciding which token to pick next. Let's look at a number of cases:
