# Concise Implementation of Recurrent Neural Networks {#sec-rnn-concise}

Like most of our from-scratch implementations,
@sec-rnn-scratch was designed 
...
Inheriting from the `RNNLMScratch` class in @sec-rnn-scratch, 
...
1. Implement the autoregressive model of @sec-sequence using an RNN.
