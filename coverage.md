# Notebook Coverage by Framework

## Framework-Independent Chapters

These chapters contain no executable code notebooks (prose, math, or references only):
...
## Per-Notebook Coverage

Legend: **x** = notebook exists for that framework, **GPU** = notebook uses GPU

| Notebook | PT | TF | JAX | MX | GPU |
|----------|:--:|:--:|:---:|:--:|:---:|
| **appendix-mathematics-for-deep-learning** | | | | | |
| distributions | x | x | x | x |  |
| eigendecomposition | x | x | x | x |  |
| geometry-linear-algebraic-ops | x | x | x | x |  |
| information-theory | x | x | x | x |  |
| integral-calculus | x | x | x | x |  |
| maximum-likelihood | x | x | x | x |  |
| multivariable-calculus | x | x | x | x |  |
| naive-bayes | x | x | x | x |  |
| random-variables | x | x | x | x |  |
| single-variable-calculus | x | x | x | x |  |
| statistics | x | x | x | x |  |
| **appendix-tools-for-deep-learning** | | | | | |
| utils | x | x | x | x | GPU |
| **attention-mechanisms-and-transformers** | | | | | |
| attention-pooling | x | x | x | x |  |
| attention-scoring-functions | x | x | x | x |  |
| bahdanau-attention | x | x | x | x | GPU |
| multihead-attention | x | x | x | x |  |
...
| alexnet | x | x | x | x | GPU |
| batch-norm | x | x | x | x | GPU |
| cnn-design | x | x | x | x | GPU |
| densenet | x | x | x | x | GPU |
| googlenet | x | x | x | x | GPU |
| nin | x | x | x | x | GPU |
| resnet | x | x | x | x | GPU |
| vgg | x | x | x | x | GPU |
...
| softmax-regression-concise | x | x | x | x | GPU |
| softmax-regression-scratch | x | x | x | x | GPU |
| **linear-regression** | | | | | |
| linear-regression | x | x | x | x |  |
| linear-regression-concise | x | x | x | x | GPU |
| linear-regression-scratch | x | x | x | x | GPU |
| oo-design | x | x | x | x | GPU |
| synthetic-regression-data | x | x | x | x |  |
| weight-decay | x | x | x | x | GPU |
| **multilayer-perceptrons** | | | | | |
| dropout | x | x | x | x | GPU |
| kaggle-house-price | x | x | x | x | GPU |
| mlp | x | x | x | x |  |
...
| convexity | x | x | x | x |  |
| gd | x | x | x | x |  |
| lr-scheduler | x | x | x | x | GPU |
| minibatch-sgd | x | x | x | x | GPU |
| momentum | x | x | x | x | GPU |
| optimization-intro | x | x | x | x |  |
| rmsprop | x | x | x | x | GPU |
| sgd | x | x | x | x | GPU |
| **preface** | | | | | |
| index | x | x | x | x |  |
...
| **recurrent-modern** | | | | | |
| bi-rnn | x | x | x | x |  |
| deep-rnn | x | x | x | x | GPU |
| encoder-decoder | x | x | x | x |  |
| gru | x | x | x | x | GPU |
| lstm | x | x | x | x | GPU |
| machine-translation-and-dataset | x | x | x | x |  |
| seq2seq | x | x | x | x | GPU |
| **recurrent-neural-networks** | | | | | |
| language-model | x | x | x | x |  |
| rnn | x | x | x | x |  |
| rnn-concise | x | x | x | x | GPU |
| rnn-scratch | x | x | x | x | GPU |
| sequence | x | x | x | x | GPU |
| text-sequence | x | x | x | x |  |
...
- gaussian-processes/gp-inference
- gaussian-processes/gp-priors
- hyperparameter-optimization/rs-async
- hyperparameter-optimization/sh-async
- natural-language-processing-pretraining/subword-embedding
- reinforcement-learning/qlearning
- reinforcement-learning/value-iter

## Coverage Gaps (present in some frameworks, missing in others)
