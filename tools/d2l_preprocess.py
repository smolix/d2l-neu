...
CHAPTER_NUMBERING = {
    ...
    'chapter_builders-guide/parameters.md': [6, 2],
    'chapter_builders-guide/init-param.md': [6, 3],
    'chapter_builders-guide/lazy-init.md': [6, 4],
    'chapter_builders-guide/custom-layer.md': [6, 5],
    'chapter_builders-guide/read-write.md': [6, 6],
    'chapter_builders-guide/use-gpu.md': [6, 7],
    ...
    'chapter_appendix-mathematics-for-deep-learning/index.md': [22],
    'chapter_appendix-mathematics-for-deep-learning/geometry-linear-algebraic-ops.md': [22, 1],
    'chapter_appendix-mathematics-for-deep-learning/eigendecomposition.md': [22, 2],
    'chapter_appendix-mathematics-for-deep-learning/single-variable-calculus.md': [22, 3],
    'chapter_appendix-mathematics-for-deep-learning/multivariable-calculus.md': [22, 4],
    'chapter_appendix-mathematics-for-deep-learning/integral-calculus.md': [22, 5],
    'chapter_appendix-mathematics-for-deep-learning/random-variables.md': [22, 6],
    'chapter_appendix-mathematics-for-deep-learning/maximum-likelihood.md': [22, 7],
    'chapter_appendix-mathematics-for-deep-learning/distributions.md': [22, 8],
    'chapter_appendix-mathematics-for-deep-learning/naive-bayes.md': [22, 9],
    'chapter_appendix-mathematics-for-deep-learning/statistics.md': [22, 10],
    'chapter_appendix-mathematics-for-deep-learning/information-theory.md': [22, 11],
    'chapter_appendix-tools-for-deep-learning/index.md': [23],
    'chapter_appendix-tools-for-deep-learning/jupyter.md': [23, 1],
    'chapter_appendix-tools-for-deep-learning/sagemaker.md': [23, 2],
    'chapter_appendix-tools-for-deep-learning/aws.md': [23, 3],
    'chapter_appendix-tools-for-deep-learning/colab.md': [23, 4],
    'chapter_appendix-tools-for-deep-learning/selecting-servers-gpus.md': [23, 5],
    'chapter_appendix-tools-for-deep-learning/contributing.md': [23, 6],
    'chapter_appendix-tools-for-deep-learning/utils.md': [23, 7],
    'chapter_appendix-tools-for-deep-learning/d2l.md': [23, 8],
