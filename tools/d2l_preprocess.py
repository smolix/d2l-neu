...
CHAPTER_NUMBERING = {
    ...
    'chapter_reinforcement-learning/baselines.md': [17, 5],
    'chapter_reinforcement-learning/deep-rl.md': [17, 6],
    'chapter_reinforcement-learning/actor-critic.md': [17, 7],
    'chapter_reinforcement-learning/ppo.md': [17, 8],
    'chapter_reinforcement-learning/dqn.md': [17, 9],
    'chapter_reinforcement-learning/offline-rl.md': [17, 10],
