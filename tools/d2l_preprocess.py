...
CHAPTER_NUMBERING = {
    ...
    'chapter_recurrent-modern/index.md': [13],
    'chapter_recurrent-modern/lstm.md': [13, 1],
    'chapter_recurrent-modern/seq2seq.md': [13, 2],
    'chapter_recurrent-modern/ssm.md': [13, 3],
    'chapter_recurrent-modern/mamba.md': [13, 4],
    ...
    'chapter_optimization/convexity.md': [9, 2],
    'chapter_optimization/gd.md': [9, 3],
    'chapter_optimization/sgd.md': [9, 4],
    'chapter_optimization/minibatch-sgd.md': [9, 5],
    'chapter_optimization/momentum.md': [9, 6],
    'chapter_optimization/adagrad.md': [9, 7],
    'chapter_optimization/rmsprop.md': [9, 8],
    'chapter_optimization/adadelta.md': [9, 9],
    'chapter_optimization/adam.md': [9, 10],
    'chapter_optimization/lr-scheduler.md': [9, 11],
    'chapter_computational-performance/index.md': [11],
    'chapter_computational-performance/hybridize.md': [11, 1],
    'chapter_computational-performance/async-computation.md': [11, 2],
    'chapter_computational-performance/auto-parallelism.md': [11, 3],
    'chapter_computational-performance/hardware.md': [11, 4],
    'chapter_computational-performance/multiple-gpus.md': [11, 5],
    'chapter_computational-performance/multiple-gpus-concise.md': [11, 6],
    'chapter_computational-performance/parameterserver.md': [11, 7],
    'chapter_transformers/index.md': [12],
    'chapter_computer-vision/index.md': [16],
    'chapter_computer-vision/image-augmentation.md': [16, 1],
    'chapter_computer-vision/fine-tuning.md': [16, 2],
    'chapter_computer-vision/bounding-box.md': [16, 3],
    'chapter_computer-vision/anchor.md': [16, 4],
    'chapter_computer-vision/multiscale-object-detection.md': [16, 5],
    'chapter_computer-vision/object-detection-dataset.md': [16, 6],
    'chapter_computer-vision/ssd.md': [16, 7],
    'chapter_computer-vision/rcnn.md': [16, 8],
    'chapter_computer-vision/semantic-segmentation-and-dataset.md': [16, 9],
    'chapter_computer-vision/transposed-conv.md': [16, 10],
    'chapter_computer-vision/fcn.md': [16, 11],
    'chapter_computer-vision/neural-style.md': [16, 12],
    'chapter_computer-vision/kaggle-cifar10.md': [16, 13],
    'chapter_computer-vision/kaggle-dog.md': [16, 14],
    'chapter_natural-language-processing-pretraining/index.md': [17],
    'chapter_natural-language-processing-pretraining/word2vec.md': [17, 1],
    'chapter_natural-language-processing-pretraining/approx-training.md': [17, 2],
    'chapter_natural-language-processing-pretraining/word-embedding-dataset.md': [17, 3],
    'chapter_natural-language-processing-pretraining/word2vec-pretraining.md': [17, 4],
    'chapter_natural-language-processing-pretraining/glove.md': [17, 5],
    'chapter_natural-language-processing-pretraining/subword-embedding.md': [17, 6],
    'chapter_natural-language-processing-pretraining/similarity-analogy.md': [17, 7],
    'chapter_natural-language-processing-pretraining/bert.md': [17, 8],
    'chapter_natural-language-processing-pretraining/bert-dataset.md': [17, 9],
    'chapter_natural-language-processing-pretraining/bert-pretraining.md': [17, 10],
    'chapter_natural-language-processing-applications/index.md': [18],
    'chapter_natural-language-processing-applications/sentiment-analysis-and-dataset.md': [18, 1],
    'chapter_natural-language-processing-applications/sentiment-analysis-rnn.md': [18, 2],
    'chapter_natural-language-processing-applications/sentiment-analysis-cnn.md': [18, 3],
    'chapter_natural-language-processing-applications/natural-language-inference-and-dataset.md': [18, 4],
    ...
    'chapter_diffusion-models/index.md': [15],
    'chapter_gaussian-processes/index.md': [19],
    'chapter_gaussian-processes/gp-intro.md': [19, 1],
    'chapter_gaussian-processes/gp-priors.md': [19, 2],
    'chapter_gaussian-processes/gp-inference.md': [19, 3],
    'chapter_hyperparameter-optimization/index.md': [21],
    'chapter_hyperparameter-optimization/hyperopt-intro.md': [21, 1],
    'chapter_hyperparameter-optimization/hyperopt-api.md': [21, 2],
    'chapter_hyperparameter-optimization/rs-async.md': [21, 3],
    'chapter_hyperparameter-optimization/sh-intro.md': [21, 4],
    'chapter_hyperparameter-optimization/sh-async.md': [21, 5],
    ...
    'chapter_recommender-systems/index.md': [22],
    'chapter_recommender-systems/recsys-intro.md': [22, 1],
    'chapter_recommender-systems/movielens.md': [22, 2],
    'chapter_recommender-systems/mf.md': [22, 3],
    'chapter_recommender-systems/autorec.md': [22, 4],
    'chapter_recommender-systems/ranking.md': [22, 5],
    'chapter_recommender-systems/neumf.md': [22, 6],
    'chapter_recommender-systems/seqrec.md': [22, 7],
    ...
    'chapter_mdl-linear-algebra/mdl-svd-low-rank.md': [23, 3],
    'chapter_mdl-calculus/index.md': [24],
    'chapter_mdl-calculus/mdl-single-variable-calculus.md': [24, 1],
    'chapter_mdl-calculus/mdl-multivariable-calculus.md': [24, 2],
    'chapter_mdl-calculus/mdl-matrix-calculus-autodiff.md': [24, 3],
    'chapter_mdl-calculus/mdl-integral-calculus.md': [24, 4],
    'chapter_mdl-optimization/index.md': [25],
    'chapter_mdl-optimization/mdl-gradient-based-optimization.md': [25, 1],
    'chapter_mdl-optimization/mdl-adaptive-stochastic-methods.md': [25, 2],
    'chapter_mdl-optimization/mdl-convexity.md': [25, 3],
    'chapter_mdl-optimization/mdl-constrained-optimization-duality.md': [25, 4],
    'chapter_mdl-optimization/mdl-numerical-stability-conditioning.md': [25, 5],
    'chapter_mdl-probability-statistics/index.md': [26],
    'chapter_mdl-probability-statistics/mdl-random-variables.md': [26, 1],
    'chapter_mdl-probability-statistics/mdl-distributions.md': [26, 2],
    'chapter_mdl-probability-statistics/mdl-maximum-likelihood.md': [26, 3],
    'chapter_mdl-probability-statistics/mdl-bayesian-computation.md': [26, 4],
    'chapter_mdl-probability-statistics/mdl-statistics.md': [26, 5],
    'chapter_mdl-probability-statistics/mdl-concentration-generalization.md': [26, 6],
    'chapter_mdl-probability-statistics/mdl-naive-bayes.md': [26, 7],
    'chapter_mdl-information-theory/index.md': [27],
    'chapter_mdl-information-theory/mdl-information-theory.md': [27, 1],
    'chapter_mdl-information-theory/mdl-divergences-distances.md': [27, 2],
    'chapter_mdl-information-theory/mdl-mutual-information.md': [27, 3],
    'chapter_mdl-dynamics/index.md': [28],
    'chapter_mdl-dynamics/mdl-odes-solvers.md': [28, 1],
    ...
    'chapter_appendix-tools-for-deep-learning/cloud-instances.md': [29, 3],
    'chapter_appendix-tools-for-deep-learning/hardware.md': [29, 4],
    'chapter_appendix-tools-for-deep-learning/software-ecosystem.md': [29, 5],
    'chapter_appendix-tools-for-deep-learning/training-systems.md': [29, 6],
    'chapter_appendix-tools-for-deep-learning/model-serving.md': [29, 7],
    'chapter_appendix-tools-for-deep-learning/developers-guide.md': [29, 8],
    'chapter_appendix-tools-for-deep-learning/utils.md': [29, 9],
    'chapter_appendix-tools-for-deep-learning/d2l.md': [29, 10],
