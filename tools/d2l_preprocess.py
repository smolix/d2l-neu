...
CHAPTER_NUMBERING = {
    ...
    'chapter_preliminaries/linear-algebra.md': [1, 3],
    'chapter_preliminaries/calculus.md': [1, 4],
    'chapter_preliminaries/autograd.md': [1, 5],
    'chapter_preliminaries/probability.md': [1, 6],
    'chapter_preliminaries/lookup-api.md': [1, 7],
    'chapter_linear-regression/index.md': [2],
    'chapter_linear-regression/linear-regression.md': [2, 1],
    'chapter_linear-regression/oo-design.md': [2, 2],
    'chapter_linear-regression/synthetic-regression-data.md': [2, 3],
    'chapter_linear-regression/linear-regression-scratch.md': [2, 4],
    'chapter_linear-regression/linear-regression-concise.md': [2, 5],
    'chapter_linear-regression/generalization.md': [2, 6],
    'chapter_linear-regression/weight-decay.md': [2, 7],
    'chapter_linear-classification/index.md': [3],
    'chapter_linear-classification/softmax-regression.md': [3, 1],
    'chapter_linear-classification/image-classification-dataset.md': [3, 2],
    'chapter_linear-classification/classification.md': [3, 3],
    'chapter_linear-classification/softmax-regression-scratch.md': [3, 4],
    'chapter_linear-classification/softmax-regression-concise.md': [3, 5],
    'chapter_linear-classification/generalization-classification.md': [3, 6],
    'chapter_linear-classification/environment-and-distribution-shift.md': [3, 7],
    'chapter_multilayer-perceptrons/index.md': [4],
    'chapter_multilayer-perceptrons/mlp.md': [4, 1],
    'chapter_multilayer-perceptrons/mlp-implementation.md': [4, 2],
    'chapter_multilayer-perceptrons/backprop.md': [4, 3],
    'chapter_multilayer-perceptrons/numerical-stability-and-init.md': [4, 4],
    'chapter_multilayer-perceptrons/generalization-deep.md': [4, 5],
    'chapter_multilayer-perceptrons/dropout.md': [4, 6],
    'chapter_multilayer-perceptrons/kaggle-house-price.md': [4, 7],
    'chapter_builders-guide/index.md': [5],
    'chapter_builders-guide/model-construction.md': [5, 1],
    'chapter_builders-guide/parameters-state-memory.md': [5, 2],
    'chapter_builders-guide/init.md': [5, 3],
    'chapter_builders-guide/custom-layers.md': [5, 4],
    'chapter_builders-guide/numerics.md': [5, 5],
    'chapter_builders-guide/saving-loading.md': [5, 6],
    'chapter_builders-guide/gpus-devices-memory.md': [5, 7],
    'chapter_builders-guide/reproducibility-inspection.md': [5, 8],
    'chapter_convolutional-neural-networks/index.md': [6],
    'chapter_convolutional-neural-networks/why-conv.md': [6, 1],
    'chapter_convolutional-neural-networks/conv-layer.md': [6, 2],
    'chapter_convolutional-neural-networks/padding-and-strides.md': [6, 3],
    'chapter_convolutional-neural-networks/channels.md': [6, 4],
    'chapter_convolutional-neural-networks/pooling.md': [6, 5],
    'chapter_convolutional-neural-networks/lenet.md': [6, 6],
    'chapter_convolutional-modern/index.md': [7],
    'chapter_convolutional-modern/alexnet.md': [7, 1],
    'chapter_convolutional-modern/blocks.md': [7, 2],
    'chapter_convolutional-modern/batch-norm.md': [7, 3],
    'chapter_convolutional-modern/resnet.md': [7, 4],
    'chapter_convolutional-modern/efficient-convnets.md': [7, 5],
    'chapter_convolutional-modern/training-recipes.md': [7, 6],
    'chapter_convolutional-modern/convnext.md': [7, 7],
    'chapter_convolutional-modern/cnn-design.md': [7, 8],
    'chapter_recurrent-neural-networks/index.md': [8],
    'chapter_recurrent-neural-networks/sequence.md': [8, 1],
    'chapter_recurrent-neural-networks/text-sequence.md': [8, 2],
    'chapter_recurrent-neural-networks/language-model.md': [8, 3],
    'chapter_recurrent-neural-networks/rnn.md': [8, 4],
    ...
    'chapter_optimization/sgd.md': [9, 3],
    'chapter_optimization/minibatch-sgd.md': [9, 4],
    'chapter_optimization/momentum.md': [9, 5],
    'chapter_optimization/adam.md': [9, 6],
    'chapter_optimization/adamw.md': [9, 7],
    'chapter_optimization/lr-scheduler.md': [9, 8],
    'chapter_optimization/muon.md': [9, 9],
    'chapter_optimization/batch-size.md': [9, 10],
    'chapter_optimization/scaling.md': [9, 11],
    'chapter_optimization/practice.md': [9, 12],
    'chapter_attention/index.md': [10],
    'chapter_attention/queries-keys-values.md': [10, 1],
    'chapter_attention/attention-scoring.md': [10, 2],
    'chapter_attention/multihead-attention.md': [10, 3],
    'chapter_attention/positional-information.md': [10, 4],
    'chapter_attention/attention-at-scale.md': [10, 5],
    'chapter_attention/what-attention-computes.md': [10, 6],
    'chapter_transformers/index.md': [11],
    'chapter_transformers/transformer-block.md': [11, 1],
    'chapter_transformers/gpt.md': [11, 2],
    'chapter_transformers/kv-cache.md': [11, 3],
    'chapter_transformers/encoders-decoders.md': [11, 4],
    'chapter_transformers/vision-transformer.md': [11, 5],
    'chapter_transformers/moe.md': [11, 6],
    'chapter_transformers/scaling-laws.md': [11, 7],
    'chapter_recurrent-modern/index.md': [12],
    'chapter_recurrent-modern/lstm.md': [12, 1],
    'chapter_recurrent-modern/ssm.md': [12, 2],
    'chapter_recurrent-modern/mamba.md': [12, 3],
    'chapter_recurrent-modern/matrix-state.md': [12, 4],
    'chapter_recurrent-modern/deltanet.md': [12, 5],
    'chapter_recurrent-modern/test-time-regression.md': [12, 6],
    'chapter_recurrent-modern/hybrids.md': [12, 7],
    'chapter_computational-performance/index.md': [13],
    'chapter_computational-performance/performance-model.md': [13, 1],
    'chapter_computational-performance/hardware.md': [13, 2],
    'chapter_computational-performance/compilation.md': [13, 3],
    'chapter_computational-performance/memory-precision.md': [13, 4],
    'chapter_computational-performance/multiple-gpus.md': [13, 5],
    'chapter_computational-performance/multi-gpu-practice.md': [13, 6],
    'chapter_computational-performance/fast-transformer.md': [13, 7],
    'chapter_reinforcement-learning/index.md': [14],
    'chapter_reinforcement-learning/mdp.md': [14, 1],
    'chapter_reinforcement-learning/value-iter.md': [14, 2],
    'chapter_reinforcement-learning/imitation.md': [14, 3],
    'chapter_reinforcement-learning/qlearning.md': [14, 4],
    'chapter_reinforcement-learning/policy-gradient.md': [14, 5],
    'chapter_reinforcement-learning/baselines.md': [14, 6],
    'chapter_reinforcement-learning/deep-rl.md': [14, 7],
    'chapter_deep-reinforcement-learning/index.md': [15],
    'chapter_deep-reinforcement-learning/actor-critic.md': [15, 1],
    'chapter_deep-reinforcement-learning/ppo.md': [15, 2],
    'chapter_deep-reinforcement-learning/regularized.md': [15, 3],
    'chapter_deep-reinforcement-learning/dqn.md': [15, 4],
    'chapter_deep-reinforcement-learning/sac.md': [15, 5],
    'chapter_deep-reinforcement-learning/offline-rl.md': [15, 6],
    'chapter_deep-reinforcement-learning/rl-sequences.md': [15, 7],
    'chapter_generative-adversarial-networks/index.md': [16],
    'chapter_generative-adversarial-networks/gan.md': [16, 1],
    'chapter_generative-adversarial-networks/objectives.md': [16, 2],
    'chapter_generative-adversarial-networks/relativistic.md': [16, 3],
    'chapter_generative-adversarial-networks/convergence.md': [16, 4],
    'chapter_generative-adversarial-networks/dcgan.md': [16, 5],
    'chapter_generative-adversarial-networks/conditional.md': [16, 6],
    'chapter_generative-adversarial-networks/adversarial-losses.md': [16, 7],
    'chapter_diffusion-models/index.md': [17],
    'chapter_language-models/index.md': None,
    'chapter_natural-language-processing-pretraining/index.md': [18],
    'chapter_natural-language-processing-pretraining/seq2seq.md': [18, 1],
    'chapter_natural-language-processing-pretraining/word2vec.md': [18, 2],
    'chapter_natural-language-processing-pretraining/approx-training.md': [18, 3],
    'chapter_natural-language-processing-pretraining/word-embedding-dataset.md': [18, 4],
    'chapter_natural-language-processing-pretraining/word2vec-pretraining.md': [18, 5],
    'chapter_natural-language-processing-pretraining/glove.md': [18, 6],
    'chapter_natural-language-processing-pretraining/subword-embedding.md': [18, 7],
    'chapter_natural-language-processing-pretraining/similarity-analogy.md': [18, 8],
    'chapter_natural-language-processing-pretraining/bert.md': [18, 9],
    'chapter_natural-language-processing-pretraining/bert-dataset.md': [18, 10],
    'chapter_natural-language-processing-pretraining/bert-pretraining.md': [18, 11],
    'chapter_natural-language-processing-applications/index.md': [19],
    'chapter_natural-language-processing-applications/sentiment-analysis-and-dataset.md': [19, 1],
    'chapter_natural-language-processing-applications/sentiment-analysis-rnn.md': [19, 2],
    'chapter_natural-language-processing-applications/sentiment-analysis-cnn.md': [19, 3],
    'chapter_natural-language-processing-applications/natural-language-inference-and-dataset.md': [19, 4],
    'chapter_natural-language-processing-applications/natural-language-inference-attention.md': [19, 5],
    'chapter_natural-language-processing-applications/finetuning-bert.md': [19, 6],
    'chapter_natural-language-processing-applications/natural-language-inference-bert.md': [19, 7],
    'chapter_image-models/index.md': None,
    'chapter_computer-vision/index.md': [20],
    'chapter_computer-vision/image-augmentation.md': [20, 1],
    'chapter_computer-vision/fine-tuning.md': [20, 2],
    'chapter_computer-vision/bounding-box.md': [20, 3],
    'chapter_computer-vision/anchor.md': [20, 4],
    'chapter_computer-vision/multiscale-object-detection.md': [20, 5],
    'chapter_computer-vision/object-detection-dataset.md': [20, 6],
    'chapter_computer-vision/ssd.md': [20, 7],
    'chapter_computer-vision/rcnn.md': [20, 8],
    'chapter_computer-vision/semantic-segmentation-and-dataset.md': [20, 9],
    'chapter_computer-vision/transposed-conv.md': [20, 10],
    'chapter_computer-vision/fcn.md': [20, 11],
    'chapter_computer-vision/neural-style.md': [20, 12],
    'chapter_computer-vision/kaggle-cifar10.md': [20, 13],
    'chapter_computer-vision/kaggle-dog.md': [20, 14],
    'chapter_attic/index.md': None,
    'chapter_gaussian-processes/index.md': [21],
    'chapter_gaussian-processes/gp-intro.md': [21, 1],
    'chapter_gaussian-processes/gp-priors.md': [21, 2],
    'chapter_gaussian-processes/gp-inference.md': [21, 3],
    'chapter_hyperparameter-optimization/index.md': [22],
    'chapter_hyperparameter-optimization/hyperopt-intro.md': [22, 1],
    'chapter_hyperparameter-optimization/hyperopt-api.md': [22, 2],
    'chapter_hyperparameter-optimization/rs-async.md': [22, 3],
    'chapter_hyperparameter-optimization/sh-intro.md': [22, 4],
    'chapter_hyperparameter-optimization/sh-async.md': [22, 5],
    'chapter_recommender-systems/index.md': [23],
    'chapter_recommender-systems/recsys-intro.md': [23, 1],
    'chapter_recommender-systems/movielens.md': [23, 2],
    'chapter_recommender-systems/mf.md': [23, 3],
    'chapter_recommender-systems/autorec.md': [23, 4],
    'chapter_recommender-systems/ranking.md': [23, 5],
    'chapter_recommender-systems/neumf.md': [23, 6],
    'chapter_recommender-systems/seqrec.md': [23, 7],
    'chapter_recommender-systems/ctr.md': [23, 8],
    'chapter_recommender-systems/fm.md': [23, 9],
    'chapter_recommender-systems/deepfm.md': [23, 10],
    'chapter_mathematics-for-deep-learning/index.md': None,
    'chapter_mdl-linear-algebra/index.md': [24],
    'chapter_mdl-linear-algebra/mdl-geometry-linear-algebraic-ops.md': [24, 1],
    'chapter_mdl-linear-algebra/mdl-eigendecomposition.md': [24, 2],
    'chapter_mdl-linear-algebra/mdl-svd-low-rank.md': [24, 3],
    'chapter_mdl-calculus/index.md': [25],
    'chapter_mdl-calculus/mdl-single-variable-calculus.md': [25, 1],
    'chapter_mdl-calculus/mdl-multivariable-calculus.md': [25, 2],
    'chapter_mdl-calculus/mdl-matrix-calculus-autodiff.md': [25, 3],
    'chapter_mdl-calculus/mdl-integral-calculus.md': [25, 4],
    'chapter_mdl-optimization/index.md': [26],
    'chapter_mdl-optimization/mdl-gradient-based-optimization.md': [26, 1],
    'chapter_mdl-optimization/mdl-adaptive-stochastic-methods.md': [26, 2],
    'chapter_mdl-optimization/mdl-convexity.md': [26, 3],
    'chapter_mdl-optimization/mdl-constrained-optimization-duality.md': [26, 4],
    'chapter_mdl-optimization/mdl-numerical-stability-conditioning.md': [26, 5],
    'chapter_mdl-probability-statistics/index.md': [27],
    'chapter_mdl-probability-statistics/mdl-random-variables.md': [27, 1],
    'chapter_mdl-probability-statistics/mdl-distributions.md': [27, 2],
    'chapter_mdl-probability-statistics/mdl-maximum-likelihood.md': [27, 3],
    'chapter_mdl-probability-statistics/mdl-bayesian-computation.md': [27, 4],
    'chapter_mdl-probability-statistics/mdl-statistics.md': [27, 5],
    'chapter_mdl-probability-statistics/mdl-concentration-generalization.md': [27, 6],
    'chapter_mdl-probability-statistics/mdl-naive-bayes.md': [27, 7],
    'chapter_mdl-information-theory/index.md': [28],
    'chapter_mdl-information-theory/mdl-information-theory.md': [28, 1],
    'chapter_mdl-information-theory/mdl-divergences-distances.md': [28, 2],
    'chapter_mdl-information-theory/mdl-mutual-information.md': [28, 3],
    'chapter_mdl-dynamics/index.md': [29],
    'chapter_mdl-dynamics/mdl-odes-solvers.md': [29, 1],
    'chapter_mdl-dynamics/mdl-sdes.md': [29, 2],
    'chapter_mdl-dynamics/mdl-fokker-planck-probability-flow.md': [29, 3],
    'chapter_mdl-dynamics/mdl-score-matching-diffusion-flow.md': [29, 4],
    'chapter_tools-for-deep-learning/index.md': None,
    'chapter_appendix-tools-for-deep-learning/index.md': [30],
    'chapter_appendix-tools-for-deep-learning/interactive-development.md': [30, 1],
    'chapter_appendix-tools-for-deep-learning/hosted-notebooks.md': [30, 2],
    'chapter_appendix-tools-for-deep-learning/cloud-instances.md': [30, 3],
    'chapter_appendix-tools-for-deep-learning/hardware.md': [30, 4],
    'chapter_appendix-tools-for-deep-learning/software-ecosystem.md': [30, 5],
    'chapter_appendix-tools-for-deep-learning/training-systems.md': [30, 6],
    'chapter_appendix-tools-for-deep-learning/model-serving.md': [30, 7],
    'chapter_appendix-tools-for-deep-learning/developers-guide.md': [30, 8],
    'chapter_appendix-tools-for-deep-learning/utils.md': [30, 9],
    'chapter_appendix-tools-for-deep-learning/d2l.md': [30, 10],
