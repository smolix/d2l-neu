...
CHAPTER_NUMBERING = {
    ...
    'chapter_mdl-optimization/mdl-convexity.md': [24, 2],
    'chapter_mdl-optimization/mdl-constrained-optimization-duality.md': [24, 3],
    'chapter_mdl-optimization/mdl-numerical-stability-conditioning.md': [24, 4],
    ...
    'chapter_mdl-probability-statistics/mdl-naive-bayes.md': [25, 4],
