...
CHAPTER_NUMBERING = {
    ...
    'chapter_convolutional-modern/efficient-convnets.md': [8, 5],
    'chapter_convolutional-modern/training-recipes.md': [8, 6],
    'chapter_convolutional-modern/convnext.md': [8, 7],
    ...
    'chapter_recurrent-neural-networks/rnn-implementation.md': [9, 5],
    'chapter_recurrent-neural-networks/bptt.md': [9, 6],
    'chapter_recurrent-neural-networks/decoding.md': [9, 7],
    'chapter_recurrent-modern/index.md': [10],
    'chapter_recurrent-modern/lstm.md': [10, 1],
    'chapter_recurrent-modern/seq2seq.md': [10, 2],
    'chapter_recurrent-modern/ssm.md': [10, 3],
    'chapter_recurrent-modern/mamba.md': [10, 4],
    ...
    'chapter_mdl-probability-statistics/mdl-bayesian-computation.md': [25, 4],
    'chapter_mdl-probability-statistics/mdl-statistics.md': [25, 5],
    'chapter_mdl-probability-statistics/mdl-concentration-generalization.md': [25, 6],
    'chapter_mdl-probability-statistics/mdl-naive-bayes.md': [25, 7],
