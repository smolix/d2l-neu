...
CHAPTER_NUMBERING = {
    ...
    'chapter_recurrent-modern/index.md': [9],
    'chapter_recurrent-modern/lstm.md': [9, 1],
    'chapter_recurrent-modern/seq2seq.md': [9, 2],
    'chapter_recurrent-modern/ssm.md': [9, 3],
    'chapter_recurrent-modern/mamba.md': [9, 4],
    'chapter_attention-mechanisms-and-transformers/index.md': [10],
    'chapter_attention-mechanisms-and-transformers/queries-keys-values.md': [10, 1],
    'chapter_attention-mechanisms-and-transformers/attention-pooling.md': [10, 2],
    'chapter_attention-mechanisms-and-transformers/attention-scoring-functions.md': [10, 3],
    'chapter_attention-mechanisms-and-transformers/bahdanau-attention.md': [10, 4],
    'chapter_attention-mechanisms-and-transformers/multihead-attention.md': [10, 5],
    'chapter_attention-mechanisms-and-transformers/self-attention-and-positional-encoding.md': [10, 6],
    'chapter_attention-mechanisms-and-transformers/transformer.md': [10, 7],
    'chapter_attention-mechanisms-and-transformers/vision-transformer.md': [10, 8],
    'chapter_attention-mechanisms-and-transformers/large-pretraining-transformers.md': [10, 9],
    'chapter_optimization/index.md': [11],
    'chapter_optimization/optimization-intro.md': [11, 1],
    'chapter_optimization/convexity.md': [11, 2],
    'chapter_optimization/gd.md': [11, 3],
    'chapter_optimization/sgd.md': [11, 4],
    'chapter_optimization/minibatch-sgd.md': [11, 5],
    'chapter_optimization/momentum.md': [11, 6],
    'chapter_optimization/adagrad.md': [11, 7],
    'chapter_optimization/rmsprop.md': [11, 8],
    'chapter_optimization/adadelta.md': [11, 9],
    'chapter_optimization/adam.md': [11, 10],
    'chapter_optimization/lr-scheduler.md': [11, 11],
    'chapter_computational-performance/index.md': [12],
    'chapter_computational-performance/hybridize.md': [12, 1],
    'chapter_computational-performance/async-computation.md': [12, 2],
    'chapter_computational-performance/auto-parallelism.md': [12, 3],
    'chapter_computational-performance/hardware.md': [12, 4],
    'chapter_computational-performance/multiple-gpus.md': [12, 5],
    'chapter_computational-performance/multiple-gpus-concise.md': [12, 6],
    'chapter_computational-performance/parameterserver.md': [12, 7],
    'chapter_computer-vision/index.md': [13],
    'chapter_computer-vision/image-augmentation.md': [13, 1],
    'chapter_computer-vision/fine-tuning.md': [13, 2],
    'chapter_computer-vision/bounding-box.md': [13, 3],
    'chapter_computer-vision/anchor.md': [13, 4],
    'chapter_computer-vision/multiscale-object-detection.md': [13, 5],
    'chapter_computer-vision/object-detection-dataset.md': [13, 6],
    'chapter_computer-vision/ssd.md': [13, 7],
    'chapter_computer-vision/rcnn.md': [13, 8],
    'chapter_computer-vision/semantic-segmentation-and-dataset.md': [13, 9],
    'chapter_computer-vision/transposed-conv.md': [13, 10],
    'chapter_computer-vision/fcn.md': [13, 11],
    'chapter_computer-vision/neural-style.md': [13, 12],
    'chapter_computer-vision/kaggle-cifar10.md': [13, 13],
    'chapter_computer-vision/kaggle-dog.md': [13, 14],
    'chapter_natural-language-processing-pretraining/index.md': [14],
    'chapter_natural-language-processing-pretraining/word2vec.md': [14, 1],
    'chapter_natural-language-processing-pretraining/approx-training.md': [14, 2],
    'chapter_natural-language-processing-pretraining/word-embedding-dataset.md': [14, 3],
    'chapter_natural-language-processing-pretraining/word2vec-pretraining.md': [14, 4],
    'chapter_natural-language-processing-pretraining/glove.md': [14, 5],
    'chapter_natural-language-processing-pretraining/subword-embedding.md': [14, 6],
    'chapter_natural-language-processing-pretraining/similarity-analogy.md': [14, 7],
    'chapter_natural-language-processing-pretraining/bert.md': [14, 8],
    'chapter_natural-language-processing-pretraining/bert-dataset.md': [14, 9],
    'chapter_natural-language-processing-pretraining/bert-pretraining.md': [14, 10],
    'chapter_natural-language-processing-applications/index.md': [15],
    'chapter_natural-language-processing-applications/sentiment-analysis-and-dataset.md': [15, 1],
    'chapter_natural-language-processing-applications/sentiment-analysis-rnn.md': [15, 2],
    'chapter_natural-language-processing-applications/sentiment-analysis-cnn.md': [15, 3],
    'chapter_natural-language-processing-applications/natural-language-inference-and-dataset.md': [15, 4],
    'chapter_natural-language-processing-applications/natural-language-inference-attention.md': [15, 5],
    'chapter_natural-language-processing-applications/finetuning-bert.md': [15, 6],
    'chapter_natural-language-processing-applications/natural-language-inference-bert.md': [15, 7],
    'chapter_reinforcement-learning/index.md': [16],
    'chapter_reinforcement-learning/mdp.md': [16, 1],
    'chapter_reinforcement-learning/value-iter.md': [16, 2],
    'chapter_reinforcement-learning/qlearning.md': [16, 3],
    'chapter_gaussian-processes/index.md': [17],
    'chapter_gaussian-processes/gp-intro.md': [17, 1],
    'chapter_gaussian-processes/gp-priors.md': [17, 2],
    'chapter_gaussian-processes/gp-inference.md': [17, 3],
    'chapter_hyperparameter-optimization/index.md': [18],
    'chapter_hyperparameter-optimization/hyperopt-intro.md': [18, 1],
    'chapter_hyperparameter-optimization/hyperopt-api.md': [18, 2],
    'chapter_hyperparameter-optimization/rs-async.md': [18, 3],
    'chapter_hyperparameter-optimization/sh-intro.md': [18, 4],
    'chapter_hyperparameter-optimization/sh-async.md': [18, 5],
    'chapter_generative-adversarial-networks/index.md': [19],
    'chapter_generative-adversarial-networks/gan.md': [19, 1],
    'chapter_generative-adversarial-networks/dcgan.md': [19, 2],
    'chapter_recommender-systems/index.md': [20],
    'chapter_recommender-systems/recsys-intro.md': [20, 1],
    'chapter_recommender-systems/movielens.md': [20, 2],
    'chapter_recommender-systems/mf.md': [20, 3],
    'chapter_recommender-systems/autorec.md': [20, 4],
    'chapter_recommender-systems/ranking.md': [20, 5],
    'chapter_recommender-systems/neumf.md': [20, 6],
    'chapter_recommender-systems/seqrec.md': [20, 7],
    'chapter_recommender-systems/ctr.md': [20, 8],
    'chapter_recommender-systems/fm.md': [20, 9],
    'chapter_recommender-systems/deepfm.md': [20, 10],
    'chapter_mdl-linear-algebra/index.md': [21],
    'chapter_mdl-linear-algebra/mdl-geometry-linear-algebraic-ops.md': [21, 1],
    'chapter_mdl-linear-algebra/mdl-eigendecomposition.md': [21, 2],
    'chapter_mdl-linear-algebra/mdl-svd-low-rank.md': [21, 3],
    'chapter_mdl-calculus/index.md': [22],
    'chapter_mdl-calculus/mdl-single-variable-calculus.md': [22, 1],
    'chapter_mdl-calculus/mdl-multivariable-calculus.md': [22, 2],
    'chapter_mdl-calculus/mdl-matrix-calculus-autodiff.md': [22, 3],
    'chapter_mdl-calculus/mdl-integral-calculus.md': [22, 4],
    'chapter_mdl-optimization/index.md': [23],
    'chapter_mdl-optimization/mdl-gradient-based-optimization.md': [23, 1],
    'chapter_mdl-optimization/mdl-adaptive-stochastic-methods.md': [23, 2],
    'chapter_mdl-optimization/mdl-convexity.md': [23, 3],
    'chapter_mdl-optimization/mdl-constrained-optimization-duality.md': [23, 4],
    'chapter_mdl-optimization/mdl-numerical-stability-conditioning.md': [23, 5],
    'chapter_mdl-probability-statistics/index.md': [24],
    'chapter_mdl-probability-statistics/mdl-random-variables.md': [24, 1],
    'chapter_mdl-probability-statistics/mdl-distributions.md': [24, 2],
    'chapter_mdl-probability-statistics/mdl-maximum-likelihood.md': [24, 3],
    'chapter_mdl-probability-statistics/mdl-bayesian-computation.md': [24, 4],
    'chapter_mdl-probability-statistics/mdl-statistics.md': [24, 5],
    'chapter_mdl-probability-statistics/mdl-concentration-generalization.md': [24, 6],
    'chapter_mdl-probability-statistics/mdl-naive-bayes.md': [24, 7],
    'chapter_mdl-information-theory/index.md': [25],
    'chapter_mdl-information-theory/mdl-information-theory.md': [25, 1],
    'chapter_mdl-information-theory/mdl-divergences-distances.md': [25, 2],
    'chapter_mdl-information-theory/mdl-mutual-information.md': [25, 3],
    'chapter_mdl-dynamics/index.md': [26],
    'chapter_mdl-dynamics/mdl-odes-solvers.md': [26, 1],
    'chapter_mdl-dynamics/mdl-sdes.md': [26, 2],
