...
CHAPTER_NUMBERING = {
    ...
    'chapter_reinforcement-learning/actor-critic.md': [14, 7],
    'chapter_reinforcement-learning/ppo.md': [14, 8],
    'chapter_reinforcement-learning/dqn.md': [14, 9],
    'chapter_reinforcement-learning/offline-rl.md': [14, 10],
    'chapter_generative-adversarial-networks/index.md': [15],
    ...
    'chapter_natural-language-processing-pretraining/approx-training.md': [17, 3],
    'chapter_natural-language-processing-pretraining/word-embedding-dataset.md': [17, 4],
    'chapter_natural-language-processing-pretraining/word2vec-pretraining.md': [17, 5],
    'chapter_natural-language-processing-pretraining/glove.md': [17, 6],
    'chapter_natural-language-processing-pretraining/subword-embedding.md': [17, 7],
    'chapter_natural-language-processing-pretraining/similarity-analogy.md': [17, 8],
    'chapter_natural-language-processing-pretraining/bert.md': [17, 9],
    'chapter_natural-language-processing-pretraining/bert-dataset.md': [17, 10],
    'chapter_natural-language-processing-pretraining/bert-pretraining.md': [17, 11],
    ...
    'chapter_computer-vision/bounding-box.md': [19, 3],
    'chapter_computer-vision/anchor.md': [19, 4],
    'chapter_computer-vision/multiscale-object-detection.md': [19, 5],
    'chapter_computer-vision/object-detection-dataset.md': [19, 6],
    'chapter_computer-vision/ssd.md': [19, 7],
    'chapter_computer-vision/rcnn.md': [19, 8],
    'chapter_computer-vision/semantic-segmentation-and-dataset.md': [19, 9],
    'chapter_computer-vision/transposed-conv.md': [19, 10],
    'chapter_computer-vision/fcn.md': [19, 11],
    ...
    'chapter_gaussian-processes/gp-inference.md': [20, 3],
