...
CHAPTER_NUMBERING = {
    ...
    'chapter_reinforcement-learning/qlearning.md': [14, 3],
    'chapter_reinforcement-learning/policy-gradient.md': [14, 4],
    'chapter_reinforcement-learning/baselines.md': [14, 5],
    'chapter_reinforcement-learning/deep-rl.md': [14, 6],
